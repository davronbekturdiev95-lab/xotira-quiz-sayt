...
(function () {
  ...
  const MATN_NOMLARI = {
    ...
    natija_kuch_nom: ['Natija: 1-halqa nomi (xotira)', 'input'],
    natija_diqqat_nom: ['Natija: 2-halqa nomi (diqqat). Diqqatga ball beradigan savol qolmasa chiqmaydi', 'input'],
  ...
  function matnlarChiz() {
    ...
    const guruhlar = {
      ...
      'Natija sahifasi': ['natija_sarlavha', 'natija_salom', 'natija_kuch_nom', 'natija_diqqat_nom', 'natija_yonalish_sarlavha', 'natija_yonalish_izoh',
